...
class HelpPage
{
    ...
    <div class="wrap">
        ...
        <div style="width:533px; float:left">
            <iframe src="http://player.vimeo.com/video/19995544?title=0&amp;byline=0&amp;portrait=0" width="533" height="300" style="border:none" title="Ministry in Japan video"></iframe>
        </div>
