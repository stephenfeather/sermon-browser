...
/**
 * Test PopularityService functionality.
 */
class PopularityServiceTest extends TestCase
{
    /**
     * Mock wpdb instance.
     *
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new PopularityService();
    }
    ...
    public function testGetPopularSermons(): void
    {
        ...
        $result = $this->service->getPopularSermons(3);
    ...
    public function testGetPopularSermonsReturnsEmptyArray(): void
    {
        ...
        $result = $this->service->getPopularSermons(5);
    ...
    public function testGetPopularSeries(): void
    {
        ...
        $result = $this->service->getPopularSeries(2);
    ...
    public function testGetPopularSeriesReturnsEmptyArray(): void
    {
        ...
        $result = $this->service->getPopularSeries(5);
    ...
    public function testGetPopularPreachers(): void
    {
        ...
        $result = $this->service->getPopularPreachers(2);
    ...
    public function testGetPopularPreachersReturnsEmptyArray(): void
    {
        ...
        $result = $this->service->getPopularPreachers(5);
